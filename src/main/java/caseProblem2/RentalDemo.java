...
public class RentalDemo {
    ...
    public static void main(String[] args) {
        ...
        List<LessonWithRental> lista = new ArrayList<LessonWithRental>();

        LessonWithRental renta = null;
        ...
        for (int i = 0; i < 3; i++) {
            ...
            renta = new LessonWithRental(n, m, op);
        ...
        do {
            ...
            for (LessonWithRental rental : lista) {
                System.out.println(rental.toString());
                System.out.println(rental.getInstructor(op));
            }
